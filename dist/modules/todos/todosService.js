...
exports.deleteTodo = exports.updateTodo = exports.createTodo = exports.getOneTodo = exports.getTodos = void 0;
...
var getTodos = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                user = _a.sent();
                res.status(200).json({ data: user === null || user === void 0 ? void 0 : user.todos });
                return [2 /*return*/];
        }
    });
}); };
exports.getTodos = getTodos;
var getOneTodo = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var todo;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_1.default.todo.findFirst({
...
var createTodo = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_1.default.todo.create({
...
var updateTodo = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_1.default.todo.update({
                    where: {
                        userId_id: {
                            id: req.params.id,
                            userId: req.user.id,
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, db_1.default.todo.deleteMany({
                        where: { id: req.params.id, userId: req.user.id },
                    })];
            case 2:
                deleted = _a.sent();
